  ...
  return (
    <div className="prophet-root">
      ...
      <header className="p-masthead">
        <div className="p-mast-rule"><span>VOL. XXVI · NO. 1</span><span>{today.toUpperCase()}</span><span>Bosto, MA · TWO DOLLARS</span></div>
      ...
      <section id="p-bio" className="p-bio">
        ...
        <div className="p-bio-grid">
          <div className="p-bio-text">
            ...
            <p>I'm a graduate of Wright State (M.S. CS, December 2025) and Anna University (B.E. Mechatronics, 2022). I'm based in Bosto, MA, and open to relocation anywhere. {CONTENT.status}.</p>
